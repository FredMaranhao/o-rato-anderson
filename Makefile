...
e-os-peitos-das-ratas.png:
	inkscape e-os-peitos-das-ratas.svg --export-png=e-os-peitos-das-ratas.png
diferente-das-macacas-e-das-mulheres.png:
	inkscape diferente-das-macacas-e-das-mulheres.svg --export-png=diferente-das-macacas-e-das-mulheres.png

e-das-vacas-e-das-cabras.png:
	inkscape e-das-vacas-e-das-cabras.svg --export-png=e-das-vacas-e-das-cabras.png

mas-janine-precisava-comer.png:
	inkscape mas-janine-precisava-comer.svg --export-png=mas-janine-precisava-comer.png

em-branco.png:
	inkscape em-branco.svg --export-png=em-branco.png
