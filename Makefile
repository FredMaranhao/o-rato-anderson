...
imagens: em-branco.png era-uma-vez.png esse-rato-morava-num-buraco.png \
	...
	anderson-veja-se-você-sai.png e-anderson-saiu-do-buraco.png e-os-três-falaram.png anderson-disse-que-ia-junto.png quando-chegaram-perto-da-casa-do-homem.png fiufiu-era-um-gato-muito-perigoso.png mas-ninguém-viu-fiufiu.png então-chapa-disse-eu-conheço-um-caminho.png e-saiu-correndo-pelo-quintal.png os-outros-três-ratos-foram-atrás.png e-quando-cada-um-passava.png quando-os-quatro-ratos-estavam-atrás-da-geladeira.png \
	e-falou-umas-palavras-mágicas.png
